...
# For this you mus't call at the "container.13" slot and use your
#  item modiffier path. 
...
execute if data storage teplus:item_lore First[{id:"EnchantmentID"}] run item modify entity @s container.13 addon:set_lore/enchantment
