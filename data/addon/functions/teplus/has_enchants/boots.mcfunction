##===============================ADDON BOOTS FUNCTION===============================##
# IN CASE YOU NEED IT, this function detects when a player is wearing Custom Enchanted
#  boots. It can be a Curse or a normal Enchantment
# - You need to follow this function

execute as @s[nbt={Inventory:[{Slot:100b,tag:{CustomEnchantments:[{id:"EnchantmentID"}]}}]}] run function addon:custom_enchantment/run

execute as @s[nbt={Inventory:[{Slot:100b,tag:{CustomCurse:[{id:"CurseID"}]}}]}] run function addon:custom_enchantment/run
