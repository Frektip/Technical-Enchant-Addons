##===============================ADDON SET ENCHANTMENTS===============================##
# This function will add your enchantments Lore to the item
# - You need to add this command format per each enchantment that you add in your addon,
#   including levels. FOLLOW THIS FORMAT:

execute unless data storage teplus:item_lore {CurrentLore:['{"text":"Enchantment","color":"gray","italic":false}']} run data modify entity @s[nbt={Items:[{Slot:22b,tag:{CustomEnchantments:[{id:"Enchantment",lvl:number}]}}]}] Items[{Slot:22b}].tag.display.Lore insert 0 value "{\"text\":\"Enchantment\",\"color\":\"gray\",\"italic\":false}"
...
##1.- execute unless data storage teplus:item_lore {CurrentLore:['{"text":"Enchantment","color":"gray","italic":false}']}
...
##2.- data modify entity @s[nbt={Items:[{Slot:22b,tag:{CustomEnchantments:[{id:"Enchantment",lvl:number}]}}]}]
...
##3.- Items[{Slot:22b}].tag.display.Lore insert 0 value "{\"text\":\"Enchantment\",\"color\":\"gray\",\"italic\":false}"
