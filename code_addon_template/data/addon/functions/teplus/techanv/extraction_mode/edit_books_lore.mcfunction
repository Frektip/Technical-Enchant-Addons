##===============================EDIT LORE BOOKS FUNCTION===============================##
# This function will add the Lore of your enchantment to the output book from the Technical
#  Anvil Extracting Mode. For this, you must follow this command:

data modify entity @s[nbt={Items:[{Slot:13b,tag:{StoredCustomEnchantments:[{id:"Enchantment",lvl:number}]}}]}] Items[{Slot:13b}].tag.display.Lore insert 0 value "{\"text\":\"Enchantment\",\"color\":\"gray\",\"italic\":false}"
